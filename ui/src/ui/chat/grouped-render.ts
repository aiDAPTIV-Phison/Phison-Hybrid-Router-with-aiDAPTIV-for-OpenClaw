          ...
          ${
            hasRouting
              ? html`<span class="chat-reading-indicator__status fade-in">
                  Task dispatched to <strong class="status-tier--${routingInfo!.tier === "edge" ? "edge" : "cloud"}">${tierLabel} model</strong>, please wait…
                </span>`
              : html`<span class="chat-reading-indicator__status fade-in">
                  Dispatching task…
                </span>`
...
function renderRoutingInfoBadge(routingInfo?: ChatRoutingInfo | null) {
  ...
  return html`
    <div class="chat-routing-info fade-in">
      ...
      <span class="routing-model">${routingInfo.model}</span>
    </div>
  `;
}
...
export function renderMessageGroup(
  ...
  return html`
    <div class="chat-group ${roleClass}">
      ...
      <div class="chat-group-messages">
        ${renderRoutingInfoBadge(opts.routingInfo)}
