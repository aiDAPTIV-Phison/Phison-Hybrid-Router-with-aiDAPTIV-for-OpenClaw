...
start /min "Phison Hybrid OpenClaw Gateway" "%~dp0node.exe" "%~dp0openclaw.mjs" gateway run --port 18789 --bind loopback
...
if errorlevel 1 (
    echo [Phison Hybrid OpenClaw] Gateway failed to start within 30 seconds.
    echo [Phison Hybrid OpenClaw] Port 18789 may already be in use.
    echo [Phison Hybrid OpenClaw] Please check and try again.
